...
#define LABELFONTSIZE_IPAD 24.0
#define LABELDETAILSFONTSIZE_IPAD 16.0
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
	        ...
	        self.labelFont = [UIFont boldSystemFontOfSize:LABELFONTSIZE_IPAD];
	        self.detailsLabelFont = [UIFont boldSystemFontOfSize:LABELDETAILSFONTSIZE_IPAD];
		}
        self.xOffset = 0.0;
        self.yOffset = 0.0;
		self.margin = 20.0;
