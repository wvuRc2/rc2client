...
#define MG_PANESPLITTER_SPLIT_WIDTH		18.0	// width of split-gutter for MGSplitViewDividerStylePaneSplitter style.
...
- (void)layoutSubviews
{
	[self layoutSubviewsForInterfaceOrientation:TheApp.statusBarOrientation withAnimation:YES];
}
...
- (void)setSplitPosition:(float)posn
{
	...
	float newPosn = posn;
	BOOL constrained = NO;
	CGSize fullSize = [self splitViewSizeForOrientation:TheApp.statusBarOrientation];
